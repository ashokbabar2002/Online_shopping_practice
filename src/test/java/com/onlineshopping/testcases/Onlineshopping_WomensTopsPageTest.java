...
import com.onlineshopping.PageObjects.WomensTopsPage;
import com.onlineshopping.utilities.ReadConfig;

public class Onlineshopping_WomensTopsPageTest extends BaseClass {
	...
	public void WomensCatergory() throws Exception {
		...
		WomensTopsPage wtp = new WomensTopsPage(driver);		
		wtp.WomensTShirts();
		wtp.TopsMenu();
		wtp.AddToCart();
